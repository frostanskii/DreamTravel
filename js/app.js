...
window.onload = function () {
   ...
   const orderBody = document.querySelector('.order__tabs')
   const social = document.querySelector('.header__social');
   const headerAddres = document.querySelector('.header__address');
   const headerAccount = document.querySelector('.header__account');

   const callback = function (entries, observer) {
      if (entries[0].isIntersecting) {  //верх
         orderBody.classList.remove('_show');
         if (mainElement.clientWidth >= 630) {
            headerAccount.before(headerAddres);
         }
         else {
            social.append(headerAddres);

         }
      }
      else { // низ
         orderBody.classList.add('_show');
         if (mainElement.clientWidth >= 630) {
            // headerAccount.before(headerAddres);
            social.append(headerAddres);
         }
   ...
   if (document.clientWidth <= 630 + px) {
...
if (document.querySelector('.slider-popular__wrapper')) {
	new Swiper('.slider-popular__wrapper', {
		observer: true,
		observeParents: true,
		slidesPerView: 3,
		spaceBetween: 5,
...
if (document.querySelector('.slider-place')) {
	new Swiper('.slider-place__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 5,
		...
		pagination: {
			el: '.slider-place__dotts',
			clickable: true,
		},

		navigation: {
			nextEl: '.slider-place__arrows .slider-place__arrow-next',
			prevEl: '.slider-place__arrows .slider-place__arrow-prev',
		},
		// breakpoints: {
		// 	320: {
		// 		slidesPerView: 1,
...
if (document.querySelector('.slider-destinations__wrapper')) {
	new Swiper('.slider-destinations__wrapper', {
		observer: true,
		observeParents: true,
		slidesPerView: 3,
		spaceBetween: 0,
...
if (document.querySelector('.slider-holiday__body')) {
	new Swiper('.slider-holiday__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 15,
		...
		navigation: {
			nextEl: '.slider-holiday__arrows .slider-holiday__arrow-next',
			prevEl: '.slider-holiday__arrows .slider-holiday__arrow-prev',
		},
		// breakpoints: {
		// 	320: {
		// 		slidesPerView: 1,
...
if (document.querySelector('.slider-stock__body')) {
	new Swiper('.slider-stock__body', {
		...
		// effect: 'flip',  //еффект переворота слайда
		// flipEffect: {
		// 	slideShadows: false, // тень при перевороте слайда
		// 	limitRotation: false // показ только активного слайда
		// },


		// effect: 'fade', //еффект прозрачности при смене кадров подходит для 1 слайда
		// fadeEffect: {
		...
		// effect: 'flip',  //еффект переворота слайда
		// flipEffect: {
		// 	slideShadows: true, // тень при перевороте слайда
		// 	limitRotation: true // показ только активного слайда
		// },

		// effect: 'cube', // еффект куба
		// cubeEffect: {
		// 	//насторойки тени
		// 	slideShadows: true,
		// 	shadow: true,
		...
		// effect: 'coverflow', //еффект потока хорошо работает при одновременном показе нескольких слайдов
		// cowerflowEffect: {
		// 	rotate: 20, //угол
		...
		// autoplay: {
		// 	delay: 1000, //задержка == 3 сек
		// 	stopOnLastSlide: true, //закончить на последнем слайде
		// 	disableOnInteraction: false //отключить после ручного переключения (если сам переташил слайд)
		// },
		...
		navigation: {
			nextEl: '.slider-stock__arrows .slider-stock__arrow-next',
			prevEl: '.slider-stock__arrows .slider-stock__arrow-prev',
		},
		breakpoints: {
			320: {
				slidesPerView: 1.04,
